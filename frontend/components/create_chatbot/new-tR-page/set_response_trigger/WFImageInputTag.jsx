        ...
        <div className="md:w-full px-2 py-4 rounded-lg border-2 border-dashed border-blue-400 grid place-items-center relative">
          {!showImg ? (
            ...
            <div className="relative group">
              ...
              <button
                onClick={deleteImage}
                className="absolute top-0 -right-14 opacity-0 group-hover:opacity-100 bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400 transition-opacity"
              >
