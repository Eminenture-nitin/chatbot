...
const UserNameEmailAvatar = ({
  ...
  return (
    <div className="w-full flex items-center justify-start text-gray-900 whitespace-nowrap dark:text-white">
      <div className="w-10">
        <div
          className={`grid place-content-center relative cursor-pointer rounded-full text-white font-normal ${
            size ? "w-8 h-8" : "w-10 h-10"
          }`}
          style={{
            background: getBackgroundColor(letter),
          }}
        >
          <span className="text-md text-center">{letter}</span>
          {isActive && (
