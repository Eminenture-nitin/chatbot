...
const UsersStat = ({ users, isLoading, label, assistantsSide }) => {
  //   console.log(users);
  const router = useRouter();
  return (
    <div className="flex flex-col max-w-lg overflow-hidden shadow-lg w-full h-full border bg-white">
                ...
                <div className="w-[20%] pt-1 cursor-pointer flex flex-col items-center justify-between h-full gap-0">
                  {assistantsSide ? (
                    <button
                      ...
                      type="button"
                      className="text-gray-900 relativeborder border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm text-center inline-flex items-center"
                    >
                      {elem?.status == "Online" ? (
