...
const ThemeSelector = ({ adminId }) => {
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="flex items-center justify-between w-full max-w-xs p-4 mb-8 mt-8 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 ">
        <div className="flex items-center">
          <div
            style={{ background: selectedTheme }}
            className="inline-flex items-center justify-center flex-shrink-0 w-12 h-12 text-green-500 bg-green-100 rounded-lg dark:text-green-200"
          ></div>
