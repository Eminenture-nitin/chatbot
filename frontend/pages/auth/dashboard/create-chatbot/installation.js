...
const Installation = () => {
  ...
  return (
    <div className="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
      ...
      >
        <button className="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800">
      ...
      {show == true &&
        (loading == true ? (
          ...
          <div aria-labelledby="accordion-color-heading-1">
            <div className=" p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
              <div className="border rounded-lg overflow-hidden">
                ...
                <pre className="p-4 language-bash bg-white dark:text-black">
                  <code>{code}</code>
                </pre>
              </div>
            </div>
